...
# Menulis daftar token ke dalam file output
...
Dilakukan secara manual, dengan cara mencocokkan kata-kata dari 50 token di```output.txt``` dengan jawaban asli responden.
